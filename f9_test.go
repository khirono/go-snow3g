...
func TestF9_TestSet1(t *testing.T) {
	...
	length := uint64(88)
	mact := []byte{0x73, 0x1f, 0x11, 0x65}

	fresh := uint32(bearer) << 27
	got := F9(ik, count, fresh, dir, msg, length)
	if !bytes.Equal(got, mact) {
		t.Errorf("want %x; but got %x\n", mact, got)
	}
}

func TestF9_TestSet2(t *testing.T) {
	count := uint32(0x36af6144)
	bearer := uint8(0x18)
	dir := uint8(1)
	ik := []byte{
...
func TestF9_TestSet3(t *testing.T) {
	count := uint32(0xc7590ea9)
	bearer := uint8(0x17)
	dir := uint8(0)
	ik := []byte{
...
func TestF9_TestSet4(t *testing.T) {
	count := uint32(0x36af6144)
	bearer := uint8(0x0f)
	dir := uint8(1)
	ik := []byte{
...
func TestF9_TestSet5(t *testing.T) {
	count := uint32(0x36af6144)
	bearer := uint8(0x18)
	dir := uint8(0)
	ik := []byte{
...
func TestF9_TestSet6(t *testing.T) {
	count := uint32(0x7827fab2)
	bearer := uint8(0x05)
	dir := uint8(1)
	ik := []byte{
...
func TestF9_TestSet7(t *testing.T) {
	count := uint32(0x296f393c)
	bearer := uint8(0x0b)
	dir := uint8(1)
	ik := []byte{
